...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" style="background-color: #ccc">
<!-- Navigation
    ==========================================-->
 ...
 <div style="text-align:center">
  ...
  <form class="form-horizontal" role="form">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-6 col-md-10 input-lg">
          ...
          <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="form-group">
                        <div class="col-md-offset-2 col-md-10 col-sm-6 col-sm-offset-2"  >
