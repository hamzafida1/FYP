    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="{{ route('register') }}" class="page-scroll">Sign up</a></li>
          <li><button style="margin-left:15px" type="button" class="btn navbar-btn btn-success">Post Your Case</button></li>
